...
from nn.network.cells import bouncing_ode_cell, spring_ode_cell, gravity_ode_cell, pendulum_cell, pendulum_scale_cell, pendulum_intensity_cell, sliding_block_cell, bouncing_ball_drop_cell, ball_throw_cell
            ...
            with tf.variable_scope("decoder"):
                ...
                for loc, join in zip(tf.split(inp, self.n_objs, -1), tf.split(joint, self.n_objs, 0)):
                    ...
                    if self.task == 'pendulum':
                        ...
                        theta5 = -sigma * tf.expand_dims(position[1], 0) * tf.cos(loc[:, 0])
