...
from util.initialValues import estimate_initial_vals_ball_throw_cvdl
...
@hydra.main(config_path=CONFIG_DIR, config_name="ball_throw_cvdl")
def main(cfg: DictConfig):
    ...
    init_values_estimate = estimate_initial_vals_ball_throw_cvdl(
